...
function soma(nValor1, nValor2, nResultados)
        ...
        QOut("O Resultado da soma desses valores é: " + Str(nResultados))
...
function diferenca(nValor1, nValor2, nResultados)
        ...
        QOut("A diferença entre esses valores é: " + Str(nResultados))
...
function produto(nValor1, nValor2, nResultados)
        ...
        nResultados = nValor1 * nValor2
        QOut("O produto deste valores é: " + Str(nResultados))
...
function quociente(nValor1, nValor2, nResultados)
        ...
        nResultados = nValor1 / nValor2
        QOut("O quociente deste valores é: " + Str(nResultados))
