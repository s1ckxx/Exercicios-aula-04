...
#DEFINE MESESDOANO {"Janeiro", "Fevereiro", "Março", "Abril", ;
...
Function Main()
        ...
        elseif (nMes == 1) .or. (nMes == 3) .or. (nMes == 5) .or. ;
               ...
               (nMes == 12)
                QOUT("O mês informado foi " + MESESDOANO[nMes] + " e possui 31 dias!")
        else
                QOUT("O mês informado foi " + MESESDOANO[nMes] + " e possui 30 dias!")
        end if
